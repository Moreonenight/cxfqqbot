...
async def _(session: NLPSession):
	...
	global _can_repeat	
	result = None
	if group_dict[group_id][0] == None:
		group_dict[group_id][0] = session
		return None   
	if group_dict[group_id][1] == None:
	...
	if group_dict[group_id][1] and \
		...
		if _can_break == True:
			result = NLPResult(100.0, '说打断', {'message': group_dict[group_id][1].msg})
		if _can_repeat == True:
			result = NLPResult(100.0, '复读', {'message': group_dict[group_id][1].msg})
